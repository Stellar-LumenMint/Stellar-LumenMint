...
reported to the maintainers at the organisation's contact address, or — if you
prefer not to email — through a private
[security advisory](https://github.com/Stellar-LumenMint/Stellar-LumenMint/security/advisories/new)
on this repository, which is visible only to maintainers.
...
people involved is allowed during this period. Violating these terms may lead to
a permanent ban.
