...
NEXT_PUBLIC_BASE_URL=https://Stellar-LumenMint.com
```
...
This i18n implementation is part of the Stellar-LumenMint project and follows the same licensing terms.
