...
Soroban smart contract for comprehensive transaction orchestration on the Stellar blockchain.  Part of the Stellar-LumenMint monorepo.

## Overview

`transaction_contract` acts as the **central transaction coordinator** for all complex multi-step NFT workflows — minting, trading, bundling, and cross-contract calls — across the Stellar-LumenMint ecosystem.  It provides:
