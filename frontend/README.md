...
Stellar-LumenMint Frontend is the browser-based marketplace and creator interface for the Stellar-LumenMint platform. It is built with Next.js and combines locale-aware routing, Stellar wallet connectivity, GraphQL consumption, responsive layouts, PWA support, and creator-facing flows such as minting and collection management.
...
├─────────────────────────────────────────────────────────────────────┤
│ External Systems                                                    │
│  Stellar-LumenMint backend REST + GraphQL   Stellar wallets   Soroban RPC    │
└─────────────────────────────────────────────────────────────────────┘
```
