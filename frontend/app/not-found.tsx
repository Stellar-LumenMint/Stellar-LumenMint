            ...
            <div className="container-responsive py-4 md:py-8">
              ...
              >
                ...
                >
                  ...
                  <p
                    className={`${isMobile ? 'text-lg' : 'text-xl'} text-[#8A9BB0] leading-relaxed`}
                  >
                    {t('notFound.message')}
                  </p>
                  <p className={`${isMobile ? 'text-sm' : 'text-base'} text-[#6B7A8D] font-mono`}>
                ...
                <div className={isMobile ? 'w-full max-w-2xl mt-8' : 'w-[540px] ml-8'}>
                  <LottiePlayer />
                </div>
              </div>
            </div>
