...
import { Clock, Gavel, ChevronLeft, ChevronRight, X, ArrowUpDown, Filter } from 'lucide-react';
...
type CategoryFilter =
  'all' | 'Art' | 'Collectibles' | 'Gaming' | 'Music' | 'Photography' | 'Virtual Worlds' | 'Sports';
