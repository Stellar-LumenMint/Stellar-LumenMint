...
const TelemetryProvider = dynamic(() => import('./TelemetryProvider'), { ssr: false });
...
export const metadata = {
  ...
  description:
    'The premier NFT marketplace on Stellar. Discover, collect, and trade unique digital assets with secure, fast, low-fee transactions.',
  ...
  icons: {
    icon: [{ url: '/stellar-lumenmint-mark.svg', sizes: 'any', type: 'image/svg+xml' }],
    apple: [{ url: '/stellar-lumenmint-mark.svg', sizes: 'any', type: 'image/svg+xml' }],
  },
  openGraph: {
    type: 'website',
    ...
    title: 'Stellar-LumenMint — Discover, Collect & Trade NFTs',
    description:
      'The premier NFT marketplace on Stellar. Discover, collect, and trade unique digital assets.',
