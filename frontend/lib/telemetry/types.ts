...
export interface TelemetryPayloadMap {
  ...
  wallet_connect_modal_closed: {
    close_reason:
      'backdrop_click' | 'escape_key' | 'close_button' | 'connect_success' | 'route_change';
  };
...
export type TelemetryPayload<T extends TelemetryEventName> = T extends keyof TelemetryPayloadMap
