...
import {
  mapCreatorErrorToCode,
  CreatorFailureStage,
  CreatorErrorCode,
} from './creator-error-codes';
...
// --- Collection Creation ---
export function emitCollectionCreateSubmitted({
  surface,
  has_banner_image,
  field_count,
}: {
...
export function emitCollectionCreateSucceeded({
  attempt_id,
  startMs,
  upload_used,
  redirect_target,
...
export function emitCollectionCreateFailed({
  attempt_id,
  startMs,
  error,
  failure_stage,
  ...
  startMs: number;
  error: any;
  failure_stage: CreatorFailureStage;
...
// --- Mint NFT ---
export function emitMintNFTSubmitted({
  surface,
  has_media,
  selected_collection,
  price_currency,
...
export function emitMintNFTSucceeded({
  attempt_id,
  startMs,
  upload_used,
  redirect_target,
...
export function emitMintNFTFailed({
  attempt_id,
  startMs,
  error,
  failure_stage,
