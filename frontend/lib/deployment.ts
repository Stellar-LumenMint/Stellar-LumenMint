...
export const DEPLOYED_CONTRACTS = {
  nft:
    ...
    'CDJB7TJ4FKYDHRMBQ2ZQKLL6MPHFIRZA2RNP2ENUE3D7CQR3I4IRMPQ2',
  marketplace:
    process.env.NEXT_PUBLIC_MARKETPLACE_CONTRACT_ID ||
    'CC3S7SSYEMRKD4Y6SUFC3ENHN3D3TJAPVT557R22K6IN36BXHH2X2GCU',
  collectionFactory:
    process.env.NEXT_PUBLIC_COLLECTION_FACTORY_CONTRACT_ID ||
    'CDSNB4N3YHEAHWHQT7XZB6HAEQEFRPRIZWUCEEYGJRPIRBBBOO3NS4CS',
  transaction:
    process.env.NEXT_PUBLIC_TRANSACTION_CONTRACT_ID ||
    'CAEMECNI3D34TESV36PCUBKORP3PPY4MHRDJJCQNB4D2LK4TOBDOKCJ5',
} as const;

/** The source revision the deployed contracts were built from. */
export const DEPLOYMENT_COMMIT = 'ed2bf67';
