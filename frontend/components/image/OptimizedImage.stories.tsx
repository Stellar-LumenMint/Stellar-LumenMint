...
export const Default = () => (
  <div style={{ width: 300 }}>
    <OptimizedImage src="/stellar-lumenmint-mark.svg" alt="Logo" width={120} height={40} priority />
  </div>
);
...
export const Loading = () => (
  <div style={{ width: 300 }}>
    <OptimizedImage src="/stellar-lumenmint-mark.svg" alt="Loading" width={300} height={200} />
  </div>
);
