    ...
    <section className="py-16 relative" aria-labelledby="live-auctions-heading">
      ...
      <div className="flex justify-between items-center mb-8">
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-[#00D4FF]/10 border border-[#00D4FF]/25">
            ...
            <span className="text-[#00D4FF] text-xs font-semibold uppercase tracking-widest">
              Live
            </span>
          </div>
        ...
        <Link href={`/${locale}/marketplace/auctions`}>
          <Button
            variant="link"
            className="text-[#8A9BB0] hover:text-[#00D4FF] flex items-center gap-1 text-xs transition-colors"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
        {currentItems.map((item) => {
          ...
          const glowClass = isTeal
            ? 'hover:shadow-[0_4px_24px_rgba(0,212,255,0.12)]'
            : 'hover:shadow-[0_4px_24px_rgba(123,111,255,0.12)]';
          ...
          return (
            ...
            >
              ...
              <div className="p-4 space-y-3">
                <h3 className="font-semibold text-[#EEF2F7] text-base leading-tight">
                  {item.name}
                </h3>
                ...
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-2">
                    <div
                      className="h-6 w-6 rounded-full flex items-center justify-center text-[10px] font-bold text-[#0D1117]"
