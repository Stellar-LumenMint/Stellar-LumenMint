...
export function Navbar() {
  ...
  const navLinkBase =
    'text-sm font-medium tracking-wide text-[#8A9BB0] hover:text-white transition-all duration-300 flex items-center gap-1.5 relative group';
  const navLinkActive =
    'after:absolute after:bottom-[-4px] after:left-0 after:w-0 after:h-[2px] after:bg-gradient-to-r after:from-[#00D4FF] after:to-[#7B6FFF] after:transition-all after:duration-300 group-hover:after:w-full';
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <nav
          className="flex items-center justify-between h-16 md:h-[4.5rem] relative"
        ...
        >
          ...
          <Link
            ...
            aria-label="Stellar-LumenMint Home"
          >
            <OptimizedImage
          ...
          <div className="hidden xl:flex items-center justify-center space-x-1">
            {[
              {
                href: `/${locale}/explore`,
                id: NAV_ITEM_IDS.EXPLORE,
                icon: Compass,
                label: t('navigation.explore'),
              },
              {
                href: `/${locale}/marketplace`,
                id: NAV_ITEM_IDS.MARKETPLACE,
                icon: ShoppingBag,
                label: t('navigation.marketplace'),
              },
              {
                href: `/${locale}/artists`,
                id: NAV_ITEM_IDS.ARTISTS,
                icon: Users,
                label: t('navigation.artists'),
              },
              {
                href: `/${locale}/vault`,
                id: NAV_ITEM_IDS.VAULT,
                icon: Lock,
              ...
              <Link
                ...
                onClick={(e) =>
                  handleNavClick(e, id, NAV_PLACEMENTS.NAVBAR_DESKTOP, href, 'expanded')
                }
              >
            ...
            <div className="px-4 py-5 space-y-1">
              {[
                ...
                <Link
                  ...
                  onClick={(e) => {
                    handleNavClick(e, id, NAV_PLACEMENTS.NAVBAR_MOBILE_DRAWER, href, 'drawer_open');
                    closeMenu();
                  }}
                >
                  <div className="flex items-center gap-3">
                    <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#141B24] group-hover:bg-[#1C2433] transition-colors border border-[#1E2D3D]">
                      <Icon
                        aria-hidden="true"
                        className="h-4 w-4 flex-shrink-0 group-hover:text-[#00D4FF] transition-colors"
                      />
                    </div>
                    <div>
                      <span>{label}</span>
                  ...
                  <ChevronRight
                    aria-hidden="true"
                    className="h-3.5 w-3.5 opacity-0 group-hover:opacity-40 transition-all duration-200 -translate-x-2 group-hover:translate-x-0"
                  />
                </Link>
              ))}
