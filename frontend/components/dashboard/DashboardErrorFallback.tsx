        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="mb-6 relative flex items-center justify-center">
            {isOffline ? (
              ...
              <div className="relative">
                <div
                  className="absolute inset-0 rounded-full bg-purple-500/25 animate-ping"
          ...
          <p className="text-sm text-muted-foreground leading-relaxed mb-8">
            {isOffline
              ? t('creatorDashboard.errorOfflineMessage') ||
                "It looks like you're offline. Please check your network connection and try again."
              : t('creatorDashboard.errorFallbackMessage') ||
                'Something went wrong while rendering the dashboard. We have recorded this issue and are working to resolve it.'}
          </p>
          ...
          <div className="flex flex-col gap-3 w-full">
            ...
            >
              <RefreshCw
                className={`h-4 w-4 transition-transform duration-500 ${isRetrying ? 'animate-spin' : 'group-hover:rotate-180'}`}
              />
            ...
            <Link href={localizedRoute('/marketplace')} passHref className="w-full">
              <Button
                variant="outline"
                className="w-full flex items-center justify-center gap-2 border-border/80 hover:border-purple-500/50 hover:bg-purple-500/5"
              >
          ...
          <div className="mt-6 border-t border-border/60 pt-4 w-full flex justify-center">
            <a
              href="https://discord.gg/stellar-lumenmint"
              target="_blank"
