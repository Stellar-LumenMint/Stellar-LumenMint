  ...
  theme: {
    ...
    extend: {
      backgroundImage: {
        ...
        'gradient-lm-subtle':
          'linear-gradient(135deg, rgba(0,212,255,0.12), rgba(123,111,255,0.12))',
        ...
        'gradient-cosmic':
          'radial-gradient(ellipse at 50% 0%, #0A1628 0%, #0D1117 50%, #060B12 100%)',
      },
      borderRadius: {
        lg: 'var(--radius)',
      ...
      boxShadow: {
        ...
        'card-premium':
          '0 8px 32px rgba(0,0,0,0.4), 0 0 0 1px rgba(0,212,255,0.06), inset 0 1px 1px rgba(255,255,255,0.04)',
  ...
  plugins: [
    ...
    function ({ addUtilities }: { addUtilities: (utilities: Record<string, any>) => void }) {
      addUtilities({
        ...
        '.lm-shimmer': {
          background:
            'linear-gradient(90deg, rgba(0,212,255,0) 0%, rgba(0,212,255,0.05) 50%, rgba(0,212,255,0) 100%)',
