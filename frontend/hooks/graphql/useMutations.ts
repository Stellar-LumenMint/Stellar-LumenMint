...
export function useCreateListingMutation(
  options?: MutationHookOptions<CreateListingMutation, CreateListingMutationVariables>,
) {
...
export function usePlaceBidMutation(
  ...
  return useMutation<PlaceBidMutation, PlaceBidMutationVariables>(PLACE_BID_MUTATION, options);
}
...
export function useBuyNFTMutation(
  options?: MutationHookOptions<BuyNftMutation, BuyNftMutationVariables>,
) {
  return useMutation<BuyNftMutation, BuyNftMutationVariables>(BUY_NFT_MUTATION, options);
}
