...
## Overview
The Collection module manages NFT collections in the Stellar-LumenMint-backend application. It provides REST API endpoints for creating, viewing, and managing NFT collections with statistics tracking.
