...
A scalable NestJS backend for the Stellar-LumenMint NFT marketplace platform. This service provides API endpoints for user management, NFT operations, collections, and marketplace features integrated with Stellar/Soroban smart contracts.
